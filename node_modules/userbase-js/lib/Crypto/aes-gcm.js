...
const importKeyFromMaster = async (masterKey, salt, encryptionKeyName = ENCRYPTION_KEY_NAME) => {
  const encryptionKey = await window.crypto.subtle.deriveKey(hkdf.getParams(encryptionKeyName, salt), masterKey, getEncryptionKeyParams(), KEY_IS_EXTRACTABLE, KEY_WILL_BE_USED_TO);
